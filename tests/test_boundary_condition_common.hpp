...
#ifdef USE_CUDA
  qq_d.copy_from_host(qq, cuda);
  bnd::symmetric<Real>(qq_d.ro, grid_d, qq_d.ro, 1.0, bnd::Direction::X, bnd::Side::INNER);
  qq_d.copy_to_host(qq, cuda);
#else
  bnd::symmetric<Real>(qq.ro, grid, nullptr, 1.0, bnd::Direction::X, bnd::Side::INNER);
#endif
...
#ifdef USE_CUDA
  qq_d.copy_from_host(qq, cuda);
  bnd::symmetric<Real>(qq_d.ro, grid, qq_d.ro, -1.0, bnd::Direction::X, bnd::Side::INNER);
  qq_d.copy_to_host(qq, cuda);
#else
  bnd::symmetric<Real>(qq.ro, grid, nullptr, -1.0, bnd::Direction::X, bnd::Side::INNER);
#endif
...
#ifdef USE_CUDA
  qq_d.copy_from_host(qq, cuda);
  bnd::symmetric<Real>(qq_d.ro, grid, qq_d.ro, 1.0, bnd::Direction::X, bnd::Side::OUTER);
  qq_d.copy_to_host(qq, cuda);
#else
  bnd::symmetric<Real>(qq.ro, grid, nullptr, 1.0, bnd::Direction::X, bnd::Side::OUTER);
#endif
...
#ifdef USE_CUDA
  qq_d.copy_from_host(qq, cuda);
  bnd::symmetric<Real>(qq_d.ro, grid_d, qq_d.ro, -1.0, bnd::Direction::X, bnd::Side::OUTER);
  qq_d.copy_to_host(qq, cuda);
#else
  bnd::symmetric<Real>(qq.ro, grid, nullptr, -1.0, bnd::Direction::X, bnd::Side::OUTER);
#endif
...
#ifdef USE_CUDA
  qq_d.copy_from_host(qq, cuda);
  bnd::symmetric<Real>(qq_d.ro, grid_d, qq_d.ro, 1.0, bnd::Direction::Y, bnd::Side::INNER);
  qq_d.copy_to_host(qq, cuda);
#else
  bnd::symmetric<Real>(qq.ro, grid, nullptr, 1.0, bnd::Direction::Y, bnd::Side::INNER);
#endif
...
#ifdef USE_CUDA
  qq_d.copy_from_host(qq, cuda);
  bnd::symmetric<Real>(qq_d.ro, grid_d, qq_d.ro, 1.0, bnd::Direction::Y, bnd::Side::OUTER);
  qq_d.copy_to_host(qq, cuda);
#else
  bnd::symmetric<Real>(qq.ro, grid, nullptr, 1.0, bnd::Direction::Y, bnd::Side::OUTER);
#endif
...
#ifdef USE_CUDA
  qq_d.copy_from_host(qq, cuda);
  bnd::symmetric<Real>(qq_d.ro, grid_d, qq_d.ro, 1.0, bnd::Direction::Z, bnd::Side::INNER);
  qq_d.copy_to_host(qq, cuda);
#else
  bnd::symmetric<Real>(qq.ro, grid, nullptr, 1.0, bnd::Direction::Z, bnd::Side::INNER);
#endif
...
#ifdef USE_CUDA
  qq_d.copy_from_host(qq, cuda);
  bnd::symmetric<Real>(qq_d.ro, grid_d, qq_d.ro, 1.0, bnd::Direction::Z, bnd::Side::OUTER);
  qq_d.copy_to_host(qq, cuda);
#else
  bnd::symmetric<Real>(qq.ro, grid, nullptr, 1.0, bnd::Direction::Z, bnd::Side::OUTER);
#endif
