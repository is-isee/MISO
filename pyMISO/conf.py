...
class Conf:
    ...
    def load(self):
        ...
        """
        with Path(self.data_dir, "config.yaml").open(mode="r") as f:
        ...
        self.time_data_dir = Path(self.data_dir, self.time_save_dir)
        self.mhd_data_dir = Path(self.data_dir, self.mhd_save_dir)
        self.mpi_data_dir = Path(self.data_dir, self.mpi_save_dir)
