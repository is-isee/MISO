...
inline Real space_centered_4th(const Array3D<Real> &qq, Real dxyzi, int i, int j,
  ...
  return (-qq(i + 2 * is, j + 2 * js, k + 2 * ks) +
          8.0 * qq(i + is, j + js, k + ks) - 8.0 * qq(i - is, j - js, k - ks) +
    ...
    for (int i = 0; i < grid.i_total; ++i) {
      for (int j = 0; j < grid.j_total; ++j) {
        for (int k = 0; k < grid.k_total; ++k) {
          // gas pressure
          pr(i, j, k) =
              qq_argm.ro(i, j, k) * qq_argm.ei(i, j, k) * (eos.gm - 1.0);
          ...
          ht(i, j, k) = +qq_argm.ro(i, j, k) * qq_argm.ei(i, j, k) + pr(i, j, k) +
                        bb(i, j, k) * pii4<Real> +
          ...
          // v dot b
          vb(i, j, k) = +qq_argm.vx(i, j, k) * qq_argm.bx(i, j, k) +
    ...
    for (int i = grid.i_margin; i < grid.i_total - grid.i_margin; ++i) {
      ...
      for (int j = grid.j_margin; j < grid.j_total - grid.j_margin; ++j) {
        ...
        for (int k = grid.k_margin; k < grid.k_total - grid.k_margin; ++k) {
          ...
          qq_rslt.ro(i, j, k) =
              qq_orgn.ro(i, j, k) +
              dt * (-space_centered_4th(qq_argm.ro, qq_argm.vx, dxi, i, j, k,
                                        grid.is, 0, 0) -
                    space_centered_4th(qq_argm.ro, qq_argm.vy, dyi, i, j, k, 0,
                                       grid.js, 0) -
                    space_centered_4th(qq_argm.ro, qq_argm.vz, dzi, i, j, k, 0, 0,
                                       grid.ks));
          ...
          qq_rslt.vx(i, j, k) =
              (qq_orgn.ro(i, j, k) * qq_orgn.vx(i, j, k) +
               dt *
                   (-space_centered_4th(qq_argm.ro, qq_argm.vx, qq_argm.vx, dxi,
                                        i, j, k, grid.is, 0, 0) -
                    space_centered_4th(qq_argm.ro, qq_argm.vx, qq_argm.vy, dyi, i,
                                       j, k, 0, grid.js, 0) -
                    space_centered_4th(qq_argm.ro, qq_argm.vx, qq_argm.vz, dzi, i,
                                       j, k, 0, 0, grid.ks) -
                    space_centered_4th(pr, dxi, i, j, k, grid.is, 0, 0) -
                    space_centered_4th(bb, dxi, i, j, k, grid.is, 0, 0) *
                        pii8<Real> +
                    pii4<Real> * (+space_centered_4th(qq_argm.bx, qq_argm.bx, dxi,
                                                      i, j, k, grid.is, 0, 0) +
                                  space_centered_4th(qq_argm.bx, qq_argm.by, dyi,
                                                     i, j, k, 0, grid.js, 0) +
                                  space_centered_4th(qq_argm.bx, qq_argm.bz, dzi,
                                                     i, j, k, 0, 0, grid.ks)))) /
              qq_rslt.ro(i, j, k);
          ...
          qq_rslt.vy(i, j, k) =
              (qq_orgn.ro(i, j, k) * qq_orgn.vy(i, j, k) +
               dt *
                   (-space_centered_4th(qq_argm.ro, qq_argm.vy, qq_argm.vx, dxi,
                                        i, j, k, grid.is, 0, 0) -
                    space_centered_4th(qq_argm.ro, qq_argm.vy, qq_argm.vy, dyi, i,
                                       j, k, 0, grid.js, 0) -
                    space_centered_4th(qq_argm.ro, qq_argm.vy, qq_argm.vz, dzi, i,
                                       j, k, 0, 0, grid.ks) -
                    space_centered_4th(pr, dyi, i, j, k, 0, grid.js, 0) -
                    space_centered_4th(bb, dyi, i, j, k, 0, grid.js, 0) *
                        pii8<Real> +
                    pii4<Real> * (+space_centered_4th(qq_argm.by, qq_argm.bx, dxi,
                                                      i, j, k, grid.is, 0, 0) +
                                  space_centered_4th(qq_argm.by, qq_argm.by, dyi,
                                                     i, j, k, 0, grid.js, 0) +
                                  space_centered_4th(qq_argm.by, qq_argm.bz, dzi,
                                                     i, j, k, 0, 0, grid.ks)))) /
              qq_rslt.ro(i, j, k);
          ...
          qq_rslt.vz(i, j, k) =
              (qq_orgn.ro(i, j, k) * qq_orgn.vz(i, j, k) +
               dt *
                   (-space_centered_4th(qq_argm.ro, qq_argm.vz, qq_argm.vx, dxi,
                                        i, j, k, grid.is, 0, 0) -
                    space_centered_4th(qq_argm.ro, qq_argm.vz, qq_argm.vy, dyi, i,
                                       j, k, 0, grid.js, 0) -
                    space_centered_4th(qq_argm.ro, qq_argm.vz, qq_argm.vz, dzi, i,
                                       j, k, 0, 0, grid.ks) -
                    space_centered_4th(pr, dzi, i, j, k, 0, 0, grid.ks) -
                    space_centered_4th(bb, dzi, i, j, k, 0, 0, grid.ks) *
                        pii8<Real> +
                    pii4<Real> * (+space_centered_4th(qq_argm.bz, qq_argm.bx, dxi,
                                                      i, j, k, grid.is, 0, 0) +
                                  space_centered_4th(qq_argm.bz, qq_argm.by, dyi,
                                                     i, j, k, 0, grid.js, 0) +
                                  space_centered_4th(qq_argm.bz, qq_argm.bz, dzi,
                                                     i, j, k, 0, 0, grid.ks)))) /
              qq_rslt.ro(i, j, k);
          ...
          qq_rslt.bx(i, j, k) =
              qq_orgn.bx(i, j, k) +
              dt * (-space_centered_4th(qq_argm.vy, qq_argm.bx, dyi, i, j, k, 0,
                                        grid.js, 0) -
                    space_centered_4th(qq_argm.vz, qq_argm.bx, dzi, i, j, k, 0, 0,
                                       grid.ks) +
                    space_centered_4th(qq_argm.vx, qq_argm.by, dyi, i, j, k, 0,
                                       grid.js, 0) +
                    space_centered_4th(qq_argm.vx, qq_argm.bz, dzi, i, j, k, 0, 0,
                                       grid.ks) -
          ...
          qq_rslt.by(i, j, k) =
              qq_orgn.by(i, j, k) +
              dt * (-space_centered_4th(qq_argm.vx, qq_argm.by, dxi, i, j, k,
                                        grid.is, 0, 0) -
                    space_centered_4th(qq_argm.vz, qq_argm.by, dzi, i, j, k, 0, 0,
                                       grid.ks) +
                    space_centered_4th(qq_argm.vy, qq_argm.bx, dxi, i, j, k,
                                       grid.is, 0, 0) +
                    space_centered_4th(qq_argm.vy, qq_argm.bz, dzi, i, j, k, 0, 0,
                                       grid.ks) -
          ...
          qq_rslt.bz(i, j, k) =
              qq_orgn.bz(i, j, k) +
              dt * (-space_centered_4th(qq_argm.vx, qq_argm.bz, dxi, i, j, k,
                                        grid.is, 0, 0) -
                    space_centered_4th(qq_argm.vy, qq_argm.bz, dyi, i, j, k, 0,
                                       grid.js, 0) +
                    space_centered_4th(qq_argm.vz, qq_argm.bx, dxi, i, j, k,
                                       grid.is, 0, 0) +
                    space_centered_4th(qq_argm.vz, qq_argm.by, dyi, i, j, k, 0,
                                       grid.js, 0) -
              ...
              (qq_orgn.ph(i, j, k) +
               dt * ch_divb_square *
                   (-space_centered_4th(qq_argm.bx, dxi, i, j, k, grid.is, 0, 0) -
                    ...
                    space_centered_4th(qq_argm.bz, dzi, i, j, k, 0, 0,
                                       grid.ks))) *
              std::exp(-dt / tau_divb);
          ...
          const Real Et =
              ...
              pii8<Real> * (+qq_orgn.bx(i, j, k) * qq_orgn.bx(i, j, k) +
                            qq_orgn.by(i, j, k) * qq_orgn.by(i, j, k) +
                            qq_orgn.bz(i, j, k) * qq_orgn.bz(i, j, k));

          qq_rslt.ei(i, j, k) =
              (Et +
               dt * (-space_centered_4th(ht, qq_argm.vx, dxi, i, j, k, grid.is, 0,
                                         0) -
                     space_centered_4th(ht, qq_argm.vy, dyi, i, j, k, 0, grid.js,
                                        0) -
                     space_centered_4th(ht, qq_argm.vz, dzi, i, j, k, 0, 0,
                                        grid.ks) +
                     pii4<Real> * (+space_centered_4th(vb, qq_argm.bx, dxi, i, j,
                                                       k, grid.is, 0, 0) +
                                   space_centered_4th(vb, qq_argm.by, dyi, i, j,
                                                      k, 0, grid.js, 0) +
                                   space_centered_4th(vb, qq_argm.bz, dzi, i, j,
                                                      k, 0, 0, grid.ks))) -
    ...
    for (int i = grid.i_margin; i < grid.i_total - grid.i_margin; ++i) {
      for (int j = grid.j_margin; j < grid.j_total - grid.j_margin; ++j) {
        for (int k = grid.k_margin; k < grid.k_total - grid.k_margin; ++k) {
          ...
          Real cs = std::sqrt(this->eos.gm * (this->eos.gm - 1.0) *
                              this->mhd.qq.ei(i, j, k));
          Real vv =
              std::sqrt(+this->mhd.qq.vx(i, j, k) * this->mhd.qq.vx(i, j, k) +
                        this->mhd.qq.vy(i, j, k) * this->mhd.qq.vy(i, j, k) +
                        this->mhd.qq.vz(i, j, k) * this->mhd.qq.vz(i, j, k));
          Real ca =
              std::sqrt((+this->mhd.qq.bx(i, j, k) * this->mhd.qq.bx(i, j, k) +
                         this->mhd.qq.by(i, j, k) * this->mhd.qq.by(i, j, k) +
                         this->mhd.qq.bz(i, j, k) * this->mhd.qq.bz(i, j, k)) /
                        this->mhd.qq.ro(i, j, k) * pii4<Real>);
          this->time.dt =
              std::min(this->time.dt,
                       this->cfl_number *
                           std::min<Real>({this->grid.dx[i], this->grid.dy[j],
                                           this->grid.dz[k]}) /
                           (cs + vv + ca));
        }
      }
